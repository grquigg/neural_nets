...
TEST(ForwardPass, NNForwardPassWithReluEx1_BATCH_SIZE_1) {
...
TEST(ForwardPass, NNForwardPassWithReluEx1_BATCH_SIZE_2) {
  float correctOutput[6] = {0.413f, 0.326f, 0.442f, 0.384f, 1.0f, 1.0f};
  int nWorkers = 1;
  int nThreadsPerWorker = 1;
  int batch_size = 2;
  int nLayers = 2;
